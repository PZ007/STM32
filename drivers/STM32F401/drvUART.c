...
int drvUART_start(int instId, const drvUART_serialAttr_t* attr)
{
    ...
    *cfgDrvUART[instId].RCC_clockEnableRegister |=
     ...
     */
    GPIO_pinAttr.alternate = cfgDrvUART[instId].alternateFunctionSelection;
    ...
    GPIO_pinAttr.outSpeed = DRV_GPIO_OUT_SPEED_LOW;
    ...
    drvGPIO_configPin(cfgDrvUART[instId].instIdGPIO, &GPIO_pinAttr);
...
int drvUART_stop(int instId)
{
    ...
    {
        /* Follow reverse order as in _start() function. */
