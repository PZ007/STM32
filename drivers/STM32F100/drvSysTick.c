 ...
 *
 *  Notes:          Uses the STM32F10x internal System Tick Timer as timer base.
...
#include <core_cm3.h> // For SysTick_Config(), SysTick->...
#include <system_stm32f10x.h> // For SystemCoreClock
 ...
 * This function is declared in the file startup_stm32f10x_md_vl.s.
 */
